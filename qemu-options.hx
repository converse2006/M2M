...
//evo0209
#ifdef CONFIG_SET
DEF("trace-kernel", 0, QEMU_OPTION_trace_kernel, \
    "-trace-kernel trace kernel by SET\n")
#endif

#ifdef CONFIG_VPMU
DEF("cortex-a9", 0, QEMU_OPTION_cortex_a9, \
    "-cortex-a9 using cortex-a9 pipeline model in VPMU\n")

DEF("dratio", HAS_ARG, QEMU_OPTION_dratio, \
    "-dratio <num> set the divide ratio in VPMU\n")
#endif
