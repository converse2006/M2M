...
//evo0209
static void
help_trace_kernel(stralloc_t*  out)
{
    PRINTF(
    "  use '-show-kernel' to trace linux kernel booting sequence by SET.\n\n"
    );
}
#endif
#ifdef CONFIG_VPMU
//evo0209
static void
help_cortex_a9(stralloc_t*  out)
{
    PRINTF(
    "  use '-cortex-a9' to select cpu model cortex-a9 in VPMU.\n\n"
    );
}

help_dratio(stralloc_t*  out)
{
    PRINTF(
    "  use '-dratio <number>' to set the divide ratio in VPMU.\n\n"
    );
}
#endif
