...
#ifdef CONFIG_SET
//evo0209
OPT_FLAG ( trace_kernel, "trace the kernel by SET" )
#endif
#ifdef CONFIG_VPMU
//evo0209
OPT_FLAG ( cortex_a9, "select cpu model cortex-a9 in VPMU" )
OPT_PARAM( dratio, "number", "set the divide ratio in VPMU" )
#endif
