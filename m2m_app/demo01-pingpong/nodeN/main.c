...
int main(int argc, char* argv[])
{
    ...
    char send_data1[PACKETSIZE] = "Just Go !!!!!";
    char send_data2[PACKETSIZE] = "Chun-Han Chen";
    char send_data3[PACKETSIZE] = "Zigbeenetwork";
    char send_data4[PACKETSIZE] = "M2M 012345678";
